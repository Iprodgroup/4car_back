        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        <h5 class="card-header">Добавить производителя </h5>
                        <form class="card-body" method="post" enctype="multipart/form-data" action="{{ route('admin.manufacturers.store') }}">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" name="description" id="exampleFormControlInput1" style="height: 200px;" ></textarea>
                            </div>
                            <div class="mb-3">
