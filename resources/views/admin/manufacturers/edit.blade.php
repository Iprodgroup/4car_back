                    ...
                    <div class="card">
                        ...
                        <form class="card-body" method="post" enctype="multipart/form-data" action="{{ route('admin.manufacturers.update', $manufacturer->id)}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="exampleFormControlInput1" value="<?php echo $manufacturer->name?>">
                            </div>

                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Описание</label>
                                <textarea type="text" class="form-control" name="description" id="exampleFormControlInput1" style="height: 200px;" >{{old($manufacturer->description)}}</textarea>
                            </div>
                            <div class="mb-3">
